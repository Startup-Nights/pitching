...
const navigation = [
  ...
  { name: 'Vote', href: '#', icon: ChartBarSquareIcon, current: false },
]
const events = [
  { id: 1, name: 'Seed', href: '#', initial: 'S', current: false },
  { id: 2, name: 'Pre-Seed', href: '#', initial: 'PS', current: false },
]
...
const stats = [
  { name: 'Number of applications', value: '405' },
  { name: 'Average deploy time', value: '3.65', unit: 'mins' },
  { name: 'Number of servers', value: '3' },
  { name: 'Approval rate', value: '98.5%' },
]
